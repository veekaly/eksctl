...
func deleteOrphanLoadBalancerSecurityGroups(ctx context.Context, ec2API awsapi.EC2, elbAPI DescribeLoadBalancersAPI, clusterConfig *api.ClusterConfig) error {
	...
	describeRequest := &ec22.DescribeSecurityGroupsInput{
	...
	paginator := ec22.NewDescribeSecurityGroupsPaginator(ec2API, describeRequest)
...
func deleteSecurityGroup(ctx context.Context, ec2API awsapi.EC2, sg ec2types.SecurityGroup) error {
	...
	input := &ec22.DeleteSecurityGroupInput{
		GroupId: sg.GroupId,
	}
...
func describeSecurityGroupsByID(ctx context.Context, ec2API awsapi.EC2, groupIDs []string) (*ec22.DescribeSecurityGroupsOutput, error) {
	return ec2API.DescribeSecurityGroups(ctx, &ec22.DescribeSecurityGroupsInput{
		Filters: []ec2types.Filter{
			{
