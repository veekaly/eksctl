...
func (v *ExistingVPCResourceSet) CreateTemplate(ctx context.Context) (*gfnt.Value, *SubnetDetails, error) {
	out, err := v.ec2API.DescribeVpcs(ctx, &ec22.DescribeVpcsInput{
...
func (v *ExistingVPCResourceSet) checkIPv6CidrBlockAssociated(describeVPCOutput *ec22.DescribeVpcsOutput) error {
...
func importRouteTables(ctx context.Context, ec2API awsapi.EC2, subnets map[string]api.AZSubnetSpec) (map[string]string, error) {
	...
	paginator := ec22.NewDescribeRouteTablesPaginator(ec2API, &ec22.DescribeRouteTablesInput{
